...
const createAssessment = async (userId, answers) => {
  ...
  await createNotification({
    ...
    message: `Your PCOS screening result is ${assessment.risk} risk. Review your result and recommendations.`,
    link: `/pcos-detection/${assessment._id}`,
    priority: assessment.risk === "High" ? "high" : "normal",
    uniqueKey: `pcos-assessment-${assessment._id}`,
    metadata: {
